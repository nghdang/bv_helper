...
#include <QVector>
#include "Application/Gui/Common/ProfileCategory.hpp"
...
class ProfileCategoryListModel : public QAbstractListModel
{
    ...
    Q_PROPERTY(QVector<Common::ProfileCategory> profileCategories READ getProfileCategories WRITE setProfileCategories
                 NOTIFY profileCategoriesChanged)

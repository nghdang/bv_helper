...
#include <QVector>
#include "Application/Gui/Common/ProfileItem.hpp"
...
class ProfileListModel : public QAbstractListModel
{
    ...
    Q_PROPERTY(
      QVector<Common::ProfileItem> profileItems READ getProfileItems WRITE setProfileItems NOTIFY profileItemsChanged)
